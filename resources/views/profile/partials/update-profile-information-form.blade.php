<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            @elseif (Auth::user()->socialAccounts->isNotEmpty())
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    {{ __('Anda telah login menggunakan media sosial. Anda tidak dapat mengubah alamat email Anda.') }}
                </p>
                <x-text-input id="email" name="email" type="email" class="mt-1 block w-full opacity-50" :value="old('email', $user->email)" autocomplete="email" disabled />
            @endif
