...
<head>
    ...
    <!-- Styles / Scripts -->
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/darkMode.js', 'resources/js/navbar_Highlight.js'])
...
<body id="themed" class="bg-gray-50 text-gray-800 dark:bg-gray-800">
    ...
    <div class="flex flex-row items-center mb-10 mx-5 mt-5 pt-20" id="beranda">
        <img src="aset/image1_welcome.png" loading="lazy" alt="background" class="w-1/2 h-auto rounded-md mb-6 mr-20">
    ...
    <div class="mx-5" id="tentang">
        <div class="flex flex-row items-center mb-10">
            <img src="aset/image2_welcome.png" loading="lazy" alt="Apa Itu Public Voice?" class="w-1/2 h-auto rounded-md mb-6 mr-20">
        ...
        <div class="flex flex-row items-center mb-10">
            ...
            <img src="aset/image3_welcome.png" loading="lazy"alt="Mengapa Harus Public Voice?" class="w-1/2 h-auto rounded-md mb-6 ml-20">
        </div>
    </div>
    
    <!-- Vision Mission Section -->
    <div class="flex justify-center items-stretch space-x-4 mb-10 relative mx-5 pt-24" id="visi-misi">
    
        <div class="w-1/2 text-left flex flex-col p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-400">
            <div class="text-center">
