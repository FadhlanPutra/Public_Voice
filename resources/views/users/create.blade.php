<x-app-layout>
    ...
    <section class="bg-white dark:bg-gray-900 md2:pl-64 lg:pl-64 md:pl-64 h-screen flex flex-row">
        <div class="py-8 px-4 ml-5 lg:w-1/2 lg:py-16">
            <h2 class="mb-12 text-xl font-bold text-gray-900 dark:text-white bg-blue-500 p-2 rounded-lg w-1/2 text-center">Sampaikan Laporan Anda</h2>
            <form  method="POST" enctype="multipart/form-data">
                ...
                <div class="flex justify-end items-center space-x-4 mt-5">
                    ...
                    <button type="submit" class="bg-red-500 hover:bg-red-600 text-gray-200 font-semibold py-2 px-12 rounded-lg">
                        Kirim
                    </button>
                </div>
            </form>
        ...
        <div class="py-8 px-4 ml-5 lg:w-1/2 lg:py-16 h-full overflow-y-auto">
