<x-app-layout>
    <div class="md2:pl-64 lg:pl-64 md:pl-64 mx-10 mt-4">
        <div class="flex flex-row justify-between sticky top-0 bg-gray-100 dark:bg-gray-900 p-3 pt-6 z-50 -mx-10 pl-10">
            <p class="text-black dark:text-white font-bold text-2xl">Statistik Public Voice</p>
        </div>

        <div>
            <p class="text-black dark:text-white font-bold text-xl mt-5">Data Laporan Terbaru</p>
        ...
        <div>
            <p class="text-black dark:text-white font-bold text-xl mt-5">Statistik Kategori Terbanyak</p>
